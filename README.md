...
# Live Simulation
 ...
 Try the circuit online (CircuitVerse):
 [Open BCD to 7-Segment Decoder Simulation￼](https://circuitverse.org/simulator/embed/bcd-to-7-segment-decoder-22a81ad6-631a-415b-bc49-d2c824d39557)

This interactive simulation allows you to:
	•	Change 4-bit binary inputs
	•	Observe real-time segment activation
	•	Test sequential counter behavior
	•	Verify logic gate implementation
# Overview
